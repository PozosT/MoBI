...
\setbeamercolor{block title example}{bg=unigold!80!black, fg=white}
\setbeamercolor{block body example}{bg=unigold!10}
...
\usepackage{tikz}
\usetikzlibrary{automata, positioning, arrows.meta, calc, decorations.pathreplacing}
...
\author[Alejandra Tabares]{Departamento de Ingenier\'ia Industrial}
