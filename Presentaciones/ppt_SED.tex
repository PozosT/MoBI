...
\title[Simulación de Eventos Discretos (SE…]{Simulación de Eventos Discretos (SED)}
...
En tiempo $t$:
\begin{enumerate}
\item Si $N_Q=0$: $S\leftarrow \text{IDLE}$,\quad $\texttt{time\_next\_event[2]}\leftarrow \infty$
\item Si $N_Q > 0$: tomar siguiente (FCFS), calcular demora
\[
