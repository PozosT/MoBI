...
\usetikzlibrary{automata, positioning, arrows.meta, decorations.pathreplacing, babel}
\usepackage{float}
...
\newtcolorbox{metodobox}[1][]{enhanced, breakable,
    colback=uniblue!5, colframe=uniblue, colbacktitle=uniblue, coltitle=white,
    fonttitle=\bfseries, title={#1}, arc=2mm, boxrule=0.8pt,
    left=6pt, right=6pt, top=4pt, bottom=4pt}

\newtcolorbox{ejemplobox}[1][]{enhanced, breakable,
    colback=green!5, colframe=darkgreen!70, colbacktitle=darkgreen!70, coltitle=white,
    fonttitle=\bfseries, title={#1}, arc=2mm, boxrule=0.8pt,
    left=6pt, right=6pt, top=4pt, bottom=4pt}

\newtcolorbox{notabox}[1][]{enhanced, breakable,
    colback=unigold!8, colframe=unigold!80!black, colbacktitle=unigold!80!black, coltitle=white,
    fonttitle=\bfseries, title={#1}, arc=2mm, boxrule=0.8pt,
    left=6pt, right=6pt, top=4pt, bottom=4pt}
...
\fancyhead[L]{\small\textcolor{uniblue}{Modelado bajo Incertidumbre}}
\fancyhead[R]{\small\textcolor{uniblue}{CTMC}}
\fancyfoot[C]{\thepage}
...
% ── Sections ──
\usepackage{titlesec}
\titleformat{\section}{\Large\bfseries\color{uniblue}}{\thesection}{0.8em}{}[\vspace{-0.5em}\textcolor{uniblue}{\rule{\textwidth}{0.8pt}}]
\titleformat{\subsection}{\large\bfseries\color{uniblue!80!black}}{\thesubsection}{0.7em}{}

% ── Links ──
\usepackage[colorlinks=true, linkcolor=uniblue]{hyperref}
...
\begin{center}
{\Huge\bfseries\color{uniblue} Lectura modelamiento CTMC}

\vspace{4pt}
{\large\color{uniblue!70!black} Del enunciado a la matriz generadora}

\vspace{6pt}
\textcolor{uniblue}{\rule{0.6\textwidth}{0.8pt}}
