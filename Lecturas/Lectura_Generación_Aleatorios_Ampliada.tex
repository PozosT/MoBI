...
% Configuración de cajas para ejemplos y definiciones
\newtcolorbox{definicionbox}[1]{colback=blue!5!white,colframe=blue!75!black,fonttitle=\bfseries,title=#1}
\newtcolorbox{ejemplobox}[1]{colback=green!5!white,colframe=green!60!black,fonttitle=\bfseries,title=#1}
\newtcolorbox{alertabox}[1]{colback=red!5!white,colframe=red!75!black,fonttitle=\bfseries,title=#1}

% Encabezados
\pagestyle{fancy}
\fancyhf{}
\rhead{Fundamentos de Simulación}
\lhead{Lectura: Congruencia y Transformación}
\rfoot{Página \thepage}

\title{\textbf{Lectura: Congruencia y Transformación}}
\author{Departamento de Ingeniería Industrial \\ Modelado de Sistemas Bajo Incertidumbre}
\date{\today}
