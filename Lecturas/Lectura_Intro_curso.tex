...
Podemos analizar este sistema directamente con probabilidad:

\textbf{Valor esperado de la utilidad:}
\[ E[U] = (P - C_v) \times E[D] - C_f = (50 - 30) \times 600 - 10{,}000 = 20 \times 600 - 10{,}000 = \$2{,}000 \]

\textbf{Probabilidad de pérdida ($U < 0$):}
La empresa pierde cuando $(50-30) \cdot D - 10{,}000 < 0$, es decir, cuando $D < 500$ unidades (punto de equilibrio). Dado que $D \sim N(600, 100^2)$, estandarizamos:
\[ P(D < 500) = P\!\left(Z < \frac{500 - 600}{100}\right) = P(Z < -1{.}00) \approx 0{.}1587 \approx 15{.}9\% \]

Aunque el valor esperado es \$2{,}000, hay aproximadamente un \textbf{15.9\% de probabilidad de pérdida} cuando la demanda cae por debajo del punto de equilibrio de 500 unidades. Un modelo determinístico que solo usara la media de 600 unidades proyectaría una ganancia de \$2{,}000 sin cuantificar este riesgo. Este es, precisamente, el valor del enfoque estocástico.
...
\begin{enumerate}[label={[\arabic*]}]
    \item Law, A.\,M. (2015). \textit{Simulation Modeling and Analysis}, 5th ed. McGraw-Hill. Cap.~1.
    \item Banks, J., Carson, J., Nelson, B., \& Nicol, D. (2014). \textit{Discrete-Event System Simulation}, 5th ed. Pearson. Cap.~1.
    \item Ross, S.\,M. (2014). \textit{Introduction to Probability Models}, 11th ed. Academic Press. Cap.~1.
    \item Hillier, F.\,S. \& Lieberman, G.\,J. (2015). \textit{Introduction to Operations Research}, 10th ed. McGraw-Hill. Cap.~16.
\end{enumerate}
