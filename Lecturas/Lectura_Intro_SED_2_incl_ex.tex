...
\titleformat{\subsubsection}{\normalsize\itshape\color{uniandes!60!black}}{\thesubsubsection.}{0.5em}{}
...
\begin{center}
    ...
    {\LARGE\bfseries Lectura: Simulación de Eventos Discretos}\\[0.3cm]
    {\large Principios, Mecánica de Colas, Ley de Little y Estado Estable}\\[0.5cm]
    \rule{\textwidth}{1pt}\\[0.5cm]
